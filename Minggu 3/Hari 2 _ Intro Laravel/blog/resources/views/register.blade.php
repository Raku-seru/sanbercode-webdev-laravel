...
<html>
	...
	<body>
		...
		<form action="/welcome" method="POST">
			...
			<input type="radio" name="jenkel1">Male<br>
			<input type="radio" name="jenkel2">Female<br>
			<input type="radio" name="jenkel3">Other<br><br>
			...
			<label><strong>Language Spoken :</strong></label><br><br>
			<input type="checkbox" name="bahasa">Bahasa Indonesia<br>
			<input type="checkbox" name="english">English<br>
			<input type="checkbox" name="otherlang">Other<br><br>
			<label><strong>Bio :</strong></label><br><br>
